    ...
    <Container fluid className="section footer">
      <Row>
        <Col lg={6} md={6} sm={12} xs={12}>
          ...
          <p>
            Women in Engineering Affinity Group of IEEE <br />
        ...
        <Col lg={6} md={6} sm={12} xs={12}>
          ...
          <a href="https://www.facebook.com/uwuieeewie/">
            <Icon.Facebook style={{ marginRight: "10px" }} width={32} height={32}/>
          </a>
          <a href="https://www.linkedin.com/company/wie-ieeeuwusb/">
        ...
        <Col
          ...
          sm={12}
          xs={12}
          className="topic-content apply-div"
        >
          <p>
            <br />
            <br />
            SHECODERess 2022 - All Rights reserved.
          </p>
        </Col>
      </Row>
    </Container>
